...
var args33010 = [];
var len__25865__auto___33014 = arguments.length;
var i__25866__auto___33015 = (0);
while(true){
if((i__25866__auto___33015 < len__25865__auto___33014)){
args33010.push((arguments[i__25866__auto___33015]));

var G__33016 = (i__25866__auto___33015 + (1));
i__25866__auto___33015 = G__33016;
continue;
} else {
}
break;
...
var G__33013 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__33013,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__33013;
}
});
...
var or__24790__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__25865__auto___33021 = arguments.length;
var i__25866__auto___33022 = (0);
while(true){
if((i__25866__auto___33022 < len__25865__auto___33021)){
args__25872__auto__.push((arguments[i__25866__auto___33022]));

var G__33023 = (i__25866__auto___33022 + (1));
i__25866__auto___33022 = G__33023;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__25873__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq33018){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__33019,G__33020,seq33018__$2);
});
...
var file = cljs.core.get.call(null,map__33027__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__33027__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__33027__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__33027,map__33027__$1,file,line,column){
return (function (p1__33024_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__33024_SHARP_));
});})(map__33027,map__33027__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__25715__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__25715__auto__,prefer_table__25716__auto__,method_cache__25717__auto__,cached_hierarchy__25718__auto__,hierarchy__25719__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__24790__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__24790__auto__)){
return or__24790__auto__;
} else {
...
var temp__4657__auto___33029 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___33029)){
var message_33030 = temp__4657__auto___33029;
cljs.core.println.call(null,message_33030);
} else {
}
...
var temp__4657__auto___33031 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___33031)){
var message_33032 = temp__4657__auto___33031;
cljs.core.println.call(null,message_33032);
} else {
}
...
var temp__4655__auto__ = (function (){var and__24778__auto__ = typeof exception.stack === 'string';
if(and__24778__auto__){
var G__33042 = exception.stack;
var G__33042__$1 = (((G__33042 == null))?null:clojure.string.split_lines.call(null,G__33042));
var G__33042__$2 = (((G__33042__$1 == null))?null:cljs.core.get.call(null,G__33042__$1,depth));
if((G__33042__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__33042__$2);
}
} else {
...
var vec__33043 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__33043,(0),null);
var column = cljs.core.nth.call(null,vec__33043,(1),null);
var vec__33046 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__33046,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__33046,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__33046,(2),null);
...
var m__$1 = (function (){var G__33050 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__33050) {
case "fail":
...
var G__33056 = (function (){var G__33055 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__33055);
} else {
return G__33055;
}
})();
...
return cljs.core.vary_meta.call(null,G__33058,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e33061){var e = e33061;
var G__33062 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__33062) {
...
var vec__33067 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__33067,(0),null);
var types = vec__33067;
...
return cljs.core.map.call(null,(function (p__33079){
var vec__33080 = p__33079;
var ns = cljs.core.nth.call(null,vec__33080,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__33080,(1),null);
return ((function (vec__33080,ns,vars__$1){
return (function (){
...
var G__33083 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__33083) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__33083,env,once_fixtures,each_fixtures,vec__33080,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__33083,env,once_fixtures,each_fixtures,vec__33080,ns,vars__$1){
return (function (){
var seq__33084 = cljs.core.seq.call(null,vars__$1);
var chunk__33085 = null;
var count__33086 = (0);
var i__33087 = (0);
while(true){
if((i__33087 < count__33086)){
var v = cljs.core._nth.call(null,chunk__33085,i__33087);
var temp__4657__auto___33089 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33089)){
var t_33090 = temp__4657__auto___33089;
each_fixture_fn.call(null,((function (seq__33084,chunk__33085,count__33086,i__33087,t_33090,temp__4657__auto___33089,v,each_fixture_fn,G__33083,env,once_fixtures,each_fixtures,vec__33080,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33090)));
});})(seq__33084,chunk__33085,count__33086,i__33087,t_33090,temp__4657__auto___33089,v,each_fixture_fn,G__33083,env,once_fixtures,each_fixtures,vec__33080,ns,vars__$1))
);
} else {
}

var G__33091 = seq__33084;
var G__33092 = chunk__33085;
var G__33093 = count__33086;
var G__33094 = (i__33087 + (1));
seq__33084 = G__33091;
chunk__33085 = G__33092;
count__33086 = G__33093;
i__33087 = G__33094;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__33084);
if(temp__4657__auto__){
var seq__33084__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__33084__$1)){
var c__25601__auto__ = cljs.core.chunk_first.call(null,seq__33084__$1);
var G__33095 = cljs.core.chunk_rest.call(null,seq__33084__$1);
var G__33096 = c__25601__auto__;
var G__33097 = cljs.core.count.call(null,c__25601__auto__);
var G__33098 = (0);
seq__33084 = G__33095;
chunk__33085 = G__33096;
count__33086 = G__33097;
i__33087 = G__33098;
continue;
} else {
var v = cljs.core.first.call(null,seq__33084__$1);
var temp__4657__auto___33099__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33099__$1)){
var t_33100 = temp__4657__auto___33099__$1;
each_fixture_fn.call(null,((function (seq__33084,chunk__33085,count__33086,i__33087,t_33100,temp__4657__auto___33099__$1,v,seq__33084__$1,temp__4657__auto__,each_fixture_fn,G__33083,env,once_fixtures,each_fixtures,vec__33080,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33100)));
});})(seq__33084,chunk__33085,count__33086,i__33087,t_33100,temp__4657__auto___33099__$1,v,seq__33084__$1,temp__4657__auto__,each_fixture_fn,G__33083,env,once_fixtures,each_fixtures,vec__33080,ns,vars__$1))
);
} else {
}

var G__33101 = cljs.core.next.call(null,seq__33084__$1);
var G__33102 = null;
var G__33103 = (0);
var G__33104 = (0);
seq__33084 = G__33101;
chunk__33085 = G__33102;
count__33086 = G__33103;
i__33087 = G__33104;
continue;
}
} else {
...
});})(each_fixture_fn,G__33083,env,once_fixtures,each_fixtures,vec__33080,ns,vars__$1))
);
});})(each_fixture_fn,G__33083,env,once_fixtures,each_fixtures,vec__33080,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1485470172454