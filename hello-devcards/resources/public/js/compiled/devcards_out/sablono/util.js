...
var len__25865__auto___27638 = arguments.length;
var i__25866__auto___27639 = (0);
while(true){
if((i__25866__auto___27639 < len__25865__auto___27638)){
args__25872__auto__.push((arguments[i__25866__auto___27639]));

var G__27640 = (i__25866__auto___27639 + (1));
i__25866__auto___27639 = G__27640;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq27637){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27637));
});
...
var vec__27644 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__27646;
var words = seq__27645__$1;
...
var G__27648 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__27648,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__27648;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__27649_SHARP_){
if(typeof p1__27649_SHARP_ === 'string'){
return p1__27649_SHARP_;
} else {
return cljs.core.seq.call(null,p1__27649_SHARP_);
...
//# sourceMappingURL=util.js.map?rel=1485470169160