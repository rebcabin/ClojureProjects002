...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__27652_SHARP_){
return ((p1__27652_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__27652_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__27654,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__27654;
}
});
...
var len__25865__auto___27657 = arguments.length;
var i__25866__auto___27658 = (0);
while(true){
if((i__25866__auto___27658 < len__25865__auto___27657)){
args__25872__auto__.push((arguments[i__25866__auto___27658]));

var G__27659 = (i__25866__auto___27658 + (1));
i__25866__auto___27658 = G__27659;
continue;
} else {
}
break;
...
var G__27656 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__27656,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__27656;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq27655){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27655));
});
...
var tag_name = cljs.core.nth.call(null,vec__27665,(0),null);
var names = cljs.core.nth.call(null,vec__27665,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__27665,tag_name,names){
return (function (p1__27660_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__27660_SHARP_));
});})(matches,vec__27665,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__27665,tag_name,names){
return (function (p1__27661_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__27661_SHARP_));
});})(matches,vec__27665,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__27668){
var vec__27675 = p__27668;
var seq__27676 = cljs.core.seq.call(null,vec__27675);
var first__27677 = cljs.core.first.call(null,seq__27676);
var seq__27676__$1 = cljs.core.next.call(null,seq__27676);
var tag = first__27677;
var content = seq__27676__$1;
...
var vec__27678 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__27678,(0),null);
var id = cljs.core.nth.call(null,vec__27678,(1),null);
var class$ = cljs.core.nth.call(null,vec__27678,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1485470169212