...
(ns cleaning-data.spelling-spec
  (:use [speclj.core]
        [cleaning-data.spelling]
        [clojure.string :as string :exclude (replace reverse)]))

;; The counts in the training set appear to be different than when these tests
;; were done. I'm leaving them in anyway.
...
(defn split-incorrect
  ([[k v]]
   (map #(vector k %) (string/split v #"\s+"))))
...
(describe
  "correct"
  (it "should correct 'speling.'"
      (should= "spelling" (correct "speling")))
  (it "should correct 'voteing.'"
      (should= "voting" (correct "voteing")))
  (it "should correct 'vistied.'"
      (should= "visited" (correct "vistied"))))
