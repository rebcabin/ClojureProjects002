...
(deftest speclet-test

  (testing "speclet fragments"
...
;;; The following test fails in lein test at the console
;;; because the spec :asr.core/add cannot be found. The
...
(deftest symconst-stuffss-by-term-test
